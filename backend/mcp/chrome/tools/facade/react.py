...
async def browser_react_tool(  # noqa: PLR0913, PLR0911, C901
    ...
    if action == "get_state":
        ...
        return await browser_react_get_state_tool(manager, selector, max_depth)

    if action == "find_component":
