...
class ChromeFastMCPServer:
    ...
    def _register_tools(self):  # noqa: C901
        ...
        async def browser_get_active() -> dict[str, Any]:
            """Get active browser instance."""
            return await browser_get_active_tool(self.manager)

        # Navigation tools
        @self.mcp.tool(description="Navigate to a URL")
        async def browser_navigate(url: str, wait_for: str | None = None, timeout: float = 30) -> dict[str, Any]:
            """Navigate to URL."""
        ...
        async def browser_refresh() -> dict[str, Any]:
            """Refresh page."""
        ...
        async def browser_type(selector: str, text: str, clear: bool = False, delay: float = 0) -> dict[str, Any]:
            """Type text."""
        ...
        async def browser_select(selector: str, value: str | None = None, index: int | None = None, label: str | None = None) -> dict[str, Any]:
            """Select option."""
        ...
        async def browser_scroll(direction: str = "down", amount: int = 100, selector: str | None = None) -> dict[str, Any]:
            """Scroll page."""
            return await browser_scroll_tool(self.manager, direction, amount, selector)

        @self.mcp.tool(description="Press keyboard keys")
        async def browser_press(key: str, modifiers: list[str] | None = None) -> dict[str, Any]:
            """Press keys."""
        ...
        async def browser_element_screenshot(selector: str) -> dict[str, Any]:
            """Take element screenshot."""
            return await browser_element_screenshot_tool(self.manager, selector)

        # JavaScript tools
        @self.mcp.tool(description="Execute JavaScript code")
        async def browser_execute(script: str, args: list[Any] | None = None) -> dict[str, Any]:
            """Execute JavaScript."""
